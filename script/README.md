...
The input files are the assembled genome draft and the Illumina reads of sequenced individuals. 
The output are the groups presenting the two haplotypes of each chromosome, including a number of scaffolds or contigs.
...
python 01_scaf_2_window.py RH_scaf.fasta.len 400000 ref_window_marker.id
...
## Genotyping with dosage markers
